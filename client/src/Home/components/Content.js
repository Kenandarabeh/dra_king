...
import bouziane from "../../img/bouziane.png";
import gheffari from "../../img/22.png";
import kenanda from "../../img/rabehkenanda.jpg";
      ...
      <section class="bg-light mt-5" id="tourist">
        <div class="container">
          <div class="row text-center">
            <div class="col-sm-12 col-md-12 mb-4">
              <h3 class="text-center mt-4 text-secondary"> Members</h3>
            </div>
            <div class="col-md-4">
              <div class="testimonial mb-5">
                ...
                <h6 class="font-weight-bold blue-text my-3">Student</h6>
